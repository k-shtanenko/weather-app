...
func TestOpenWeatherFetcherFactory_InterfaceImplementation(t *testing.T) {
	var _ FetcherFactory = (*OpenWeatherFetcherFactory)(nil)
}
...
func TestOpenWeatherFetcher_Fetch_EmptyWeatherArray(t *testing.T) {
	...
	assert.Equal(t, 123, weather.GetCityID())
	assert.Equal(t, "openweathermap", weather.GetSource())
	assert.Equal(t, "", weather.(*models.Weather).Weather)
	assert.Equal(t, "", weather.(*models.Weather).WeatherIcon)
}
...
func TestOpenWeatherFetcher_Fetch_MultipleWeatherItems(t *testing.T) {
	...
	assert.Equal(t, "Test City 2", weather.(*models.Weather).CityName)
	assert.Equal(t, "clear sky", weather.(*models.Weather).Weather)
	assert.Equal(t, "01d", weather.(*models.Weather).WeatherIcon)
}
...
func TestOpenWeatherFetcher_Fetch_WithGustWind(t *testing.T) {
	...
	assert.Equal(t, 8.5, weather.(*models.Weather).WindSpeed)
}
...
func TestOpenWeatherFetcher_Fetch_ValidationError(t *testing.T) {
	...
	assert.NotNil(t, weather)
	assert.Equal(t, 123, weather.GetCityID())
	assert.Equal(t, "Test City", weather.(*models.Weather).CityName)
}
