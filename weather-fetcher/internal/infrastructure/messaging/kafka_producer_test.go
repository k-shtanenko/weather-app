...
func TestKafkaProducer_ProduceBatch_Empty(t *testing.T) {
	...
	err := producer.ProduceBatch(ctx, []entities.WeatherEntity{})
...
func TestKafkaProducer_ProduceBatch_Success(t *testing.T) {
	...
	weathers := []entities.WeatherEntity{
		&entities.Weather{
			CityID:    123,
			CityName:  "Test City",
			Timestamp: time.Now(),
...
func TestKafkaProducer_ProduceBatch_SingleJSONError(t *testing.T) {
	...
	t.Run("empty batch returns nil", func(t *testing.T) {
		...
		ctx := context.Background()
		err := kafkaProducer.ProduceBatch(ctx, []entities.WeatherEntity{})
...
func TestKafkaProducer_InterfaceCheck(t *testing.T) {
	var _ ports.Producer = (*KafkaProducer)(nil)
	var _ ports.ProducerFactory = (*KafkaProducerFactory)(nil)
}
...
func TestKafkaProducer_ProduceBatch_SendMessagesError(t *testing.T) {
	...
	ctx := context.Background()
	err := kafkaProducer.ProduceBatch(ctx, []entities.WeatherEntity{weather})
...
func TestKafkaProducer_ProduceBatch_SingleMessageJSONError(t *testing.T) {
	...
	ctx := context.Background()
	err := kafkaProducer.ProduceBatch(ctx, []entities.WeatherEntity{mockWeather1, mockWeather2})
