...
type Cache interface {
	Get(ctx context.Context, key string) (models.APICacheEntity, error)
	Set(ctx context.Context, key string, data models.APICacheEntity, ttl time.Duration) error
...
func (r *RedisCache) Get(ctx context.Context, key string) (models.APICacheEntity, error) {
...
func (r *RedisCache) Set(ctx context.Context, key string, data models.APICacheEntity, ttl time.Duration) error {
