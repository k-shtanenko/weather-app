...
func (h *APIHandler) GetDailyReport(c *gin.Context) {
	...
	cacheEntry, err := h.cacheService.GetReportFromCache(ctx, models.ReportTypeDaily, cityID, periodStart, periodEnd)
	if err != nil {
	...
	if err := h.cacheService.CacheReport(ctx, models.ReportTypeDaily, cityID, periodStart, periodEnd, data,
...
func (h *APIHandler) GetWeeklyReport(c *gin.Context) {
	...
	cacheEntry, err := h.cacheService.GetReportFromCache(ctx, models.ReportTypeWeekly, cityID, periodStart, periodEnd)
	if err != nil {
		h.logger.Errorf("Cache error: %v", err)
	}
	...
	if err := h.cacheService.CacheReport(ctx, models.ReportTypeWeekly, cityID, periodStart, periodEnd, data,
...
func (h *APIHandler) GetMonthlyReport(c *gin.Context) {
	...
	cacheEntry, err := h.cacheService.GetReportFromCache(ctx, models.ReportTypeMonthly, cityID, periodStart, periodEnd)
	if err != nil {
		h.logger.Errorf("Cache error: %v", err)
	}
	...
	if err := h.cacheService.CacheReport(ctx, models.ReportTypeMonthly, cityID, periodStart, periodEnd, data,
