...
type ReportStorage interface {
	UploadReport(ctx context.Context, report models.ExcelReportEntity, data io.Reader) error
	DownloadReport(ctx context.Context, report models.ExcelReportEntity) (io.ReadCloser, error)
	DeleteReport(ctx context.Context, report models.ExcelReportEntity) error
}
...
func (m *MinioReportStorage) UploadReport(ctx context.Context, report models.ExcelReportEntity, data io.Reader) error {
...
func (m *MinioReportStorage) DownloadReport(ctx context.Context, report models.ExcelReportEntity) (io.ReadCloser, error) {
	key := m.getStorageKey(report)
	return m.storage.Download(ctx, m.bucket, key)
}

func (m *MinioReportStorage) DeleteReport(ctx context.Context, report models.ExcelReportEntity) error {
	key := m.getStorageKey(report)
	return m.storage.Delete(ctx, m.bucket, key)
}

func (m *MinioReportStorage) getStorageKey(report models.ExcelReportEntity) string {
