...
func (r *PostgresWeatherRepository) Save(ctx context.Context, data entities.WeatherDataEntity) error {
...
func (r *PostgresWeatherRepository) FindByCityIDAndDateRange(ctx context.Context, cityID int, start, end time.Time) ([]entities.WeatherDataEntity, error) {
	...
	var results []entities.WeatherDataEntity
	for rows.Next() {
...
func (r *PostgresWeatherRepository) GetDailyAggregate(ctx context.Context, cityID int, date time.Time) (entities.DailyAggregateEntity, error) {
	query := `
	...
	var aggregate entities.DailyAggregate
...
func (r *PostgresWeatherRepository) SaveDailyAggregate(ctx context.Context, aggregate entities.DailyAggregateEntity) error {
	query := `
...
func (r *PostgresWeatherRepository) UpdateDailyAggregate(ctx context.Context, aggregate entities.DailyAggregateEntity) error {
	query := `
...
func (r *PostgresReportRepository) SaveReport(ctx context.Context, report entities.ExcelReportEntity) error {
	query := `
...
func (r *PostgresReportRepository) FindReportByTypeAndPeriod(ctx context.Context, reportType entities.ReportType, cityID int, start, end time.Time) (entities.ExcelReportEntity, error) {
	query := `
	...
	var report entities.ExcelReport
...
func (r *PostgresReportRepository) FindReportByID(ctx context.Context, reportID string) (entities.ExcelReportEntity, error) {
	query := `
		SELECT id, report_type, city_id, period_start, period_end,
			file_name, file_size, storage_path, download_url,
			checksum, generated_at, expires_at
