...
type consumerHandler struct {
	handler func(ctx context.Context, message entities.WeatherDataEntity) error
	logger  logger.Logger
}
...
func (k *KafkaConsumer) Consume(ctx context.Context, handler func(ctx context.Context, message entities.WeatherDataEntity) error) error {
...
func (h *consumerHandler) deserializeMessage(data []byte) (entities.WeatherDataEntity, error) {
