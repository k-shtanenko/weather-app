...
func NewWeatherProcessor(weatherRepo database.WeatherRepository) *WeatherProcessor {
...
func (s *WeatherProcessor) ProcessWeatherData(ctx context.Context, weather models.WeatherDataEntity) error {
...
func (s *WeatherProcessor) updateDailyAggregate(ctx context.Context, weather models.WeatherDataEntity) error {
	date := time.Date(
